...
@elseif ($current_user->roles[0] == 'patient')
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-4 col-12 sidebar-menu">
              <div class="informations">
                <div class="img-banner">
                  @if ($banner_user)
                    <img src="{{ $banner_user }}" alt="<?= the_author_meta( 'display_name', $current_user->ID ); ?>">
                  @else
                    <img src="{{ get_theme_file_uri().'/dist/images/patient-lg.png' }}" alt="<?= the_author_meta( 'display_name', $current_user->ID ); ?>">
                  @endif
                </div>
                @if ($address_user)
                  <p><strong>{{ _e('location:', 'theme') }}</strong> {{ $address_user }}</p>
              ...
              <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link active" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="true">Profile</a><br/>
                <a class="nav-link" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="false">Add file</a><br/>
              </div>
            </div>
                ...
                <div class="tab-pane fade" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                  ...
                  @if ($cards) 
                    @foreach ($cards as $item)
                        @php $link = get_permalink($item->ID); @endphp
                        <a href="<?= $link; ?>" class="view-post">View Your File</a>
                    @endforeach
...
@endif
  ...
  <style>
    ...
    .view-post:hover {
      background: #C6426E;  /* fallback for old browsers */
